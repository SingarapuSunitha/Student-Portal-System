...
<p style="text-align:right">Have an account?<a href="admlogin.php">&nbspLogin</a></font></p>
</div>
<?php
...
//Selecting Database
$query = mysqli_query($conn, "SELECT * FROM adminpass WHERE user='".$user."'");
$numrows = mysqli_num_rows($query);
if($numrows == 0)
{
//Insert to Mysqli Query
$sql = "INSERT INTO adminpass(user,pass) VALUES('$user','$pass')";
