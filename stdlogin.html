...
<input type="number" placeholder="Enter Registration Number" id="user" name="user" required>
...
<p style="text-align:right">New user?<a href="stdreg.php">&nbsp Register</a></font></p>
<!--<div class="container">
<input type="text" placeholder="Enter Registration Number" id="user" name="user">
</div>
<input type="password" placeholder="Enter Password" id="pass" name="pass" />
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type="submit" name="submit"  value="Login" /><hr><br>
<a href="stdreg.php">New User?</a>-->
</form>
</body>
<?php
